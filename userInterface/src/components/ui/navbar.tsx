          ...
          {isAuthenticated ? (
            ...
            <>
              <nav className="hidden items-center gap-8 md:flex">
                ...
                <NavLink to="/for-pet-store" className={navLinkClass}>
                  Dành cho Pet Store
                </NavLink>
                ...
                <NavLink to="/user-guide" className={navLinkClass}>
                  Hướng dẫn sử dụng
                </NavLink>
              ...
              <div className="flex items-center gap-3">
                <Link to="/stores">
                  <button className="rounded-full bg-[#D56756] px-5 py-2.5 text-sm font-bold text-white shadow-[0_16px_42px_rgba(213,103,86,0.28)] transition border-2 hover:border-[#B24C40] hover:-translate-y-0.5 hover:bg-[#ffffff] hover:text-[#B24C40] hover:shadow-[0_20px_55px_rgba(213,103,86,0.28)]">
                    Tìm phòng khám
                  </button>
                </Link>
                <Link to="/auth/login">
                  <button className="rounded-full border-2 border-[#D56756] bg-transparent px-5 py-2.5 text-sm font-bold text-[#D56756] transition hover:-translate-y-0.5 hover:bg-[#D56756] hover:text-white">
                    Đăng nhập
                  </button>
                </Link>
              </div>
