        ...
        <div className="container relative mx-auto max-w-6xl">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-slate-600">
              ...
              lịch khám qua các phòng khám thú y đối tác, đồng thời cung cấp phần
              mềm quản lý toàn diện cho phòng khám & pet shop vận hành — lịch hẹn,
              hồ sơ thú cưng, hồ sơ y tế, thanh toán và báo cáo.
            </p>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="mb-14 text-center">
            ...
            <h2 className="mt-3 text-4xl font-bold text-slate-950">
              Bộ công cụ cho phòng khám đối tác
            </h2>
            <p className="mx-auto mt-4 max-w-xl text-lg text-slate-600">
              Phòng khám & pet shop đối tác không cần ghép nhiều phần mềm. PetHub
              gộp tất cả công cụ vận hành vào một nền tảng, dễ dùng cho cả người
            ...
            <div className="grid items-center gap-12 lg:grid-cols-2">
              <div className="space-y-6">
                ...
                <p className="max-w-lg text-lg leading-8 text-white/85">
                  Mỗi thú cưng có một thẻ kỹ thuật số riêng với QR Code. Chủ nuôi
                  chỉ cần quét là xem ngay toàn bộ lịch sử y tế do phòng khám đối
                  tác cập nhật — tiêm phòng, tẩy giun, khám bệnh.
                </p>
                <ul className="space-y-3">
                  {[
                    "QR Code riêng cho từng thú cưng",
                    "Chia sẻ với phòng khám đối tác trên nền tảng",
                    "Nhắc lịch tái chủng tự động",
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#B24C40] via-[#D56756] to-[#EFA29A] px-4 py-24 text-white">
        ...
        <div className="container relative mx-auto max-w-3xl text-center">
          <h2 className="text-4xl font-bold tracking-tight sm:text-5xl">
            Đưa phòng khám của bạn lên nền tảng
          </h2>
          <p className="mx-auto mt-5 max-w-xl text-lg leading-8 text-white/85">
            Dùng thử miễn phí 14 ngày. Không cần thẻ tín dụng, không cần cài đặt
            phức tạp. Trở thành phòng khám đối tác và bắt đầu vận hành trên PetHub
            chỉ trong vài phút.
          </p>
